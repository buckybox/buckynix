...
update msg model =
  case msg of
    UserTransactionListMsg userTransactionListMsg ->
      let (updatedModel, cmd) = UserTransactionList.update userTransactionListMsg model.userTransactionListModel
      in ( { model | userTransactionListModel = updatedModel }, Cmd.map UserTransactionListMsg cmd )
